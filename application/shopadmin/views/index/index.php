...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url() ?>shopadmin/assets/css/style.css">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>shopadmin/assets/js/progress-bar/number-pb.css">
...
<body> 
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>shopadmin/assets/js/jquery.js"></script>
    <script src="<?php echo base_url() ?>shopadmin/assets/js/progress-bar/src/jquery.velocity.min.js"></script>
    <script src="<?php echo base_url() ?>shopadmin/assets/js/progress-bar/number-pb.js"></script>
    <script src="<?php echo base_url() ?>shopadmin/assets/js/progress-bar/progress-app.js"></script>
    ...
    <script type="text/javascript" src="<?php echo base_url() ?>shopadmin/assets/js/chart/jquery.flot.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>shopadmin/assets/js/chart/jquery.flot.resize.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>shopadmin/assets/js/chart/realTime.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>shopadmin/assets/js/speed/canvasgauge-coustom.js"></script>
    <script type="text/javascript" src="<?php echo base_url() ?>shopadmin/assets/js/countdown/jquery.countdown.js"></script>
